...
function passwordLengthIsValid($passwordToValid)
{
    ...
    $responses=[
        "isValid"=>true,
        "msg"=>"<h2><center>Mot de passe valide!</center></H2>"
    ];
    if ($length < 6 ||$length  > 10) {
        $responses=[
        'isValid'=>false,
        "msg"=>"<h2><center>Mot de passe non valide!</H2></center></BR>Erreur : Le mot de passe doit avoir entre 6 et 10 caracteres."
        ];
      }  
    return $responses; 
}
